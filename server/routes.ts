...
import { getGygStore } from "./lib/getyourguide-store";
import { getGygInboundCredentials } from "./lib/getyourguide-auth";
import {
  clearSessionCookie,
    ...
    try {
      ...
      if (isPartner) {
        ...
        updatePayload = {
          ...
          estimatedPickupTime: partnerPayload.estimatedPickupTime ?? undefined,
