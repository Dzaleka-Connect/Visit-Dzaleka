...
export const openApiDocument = {
  ...
  info: {
    ...
    description: [
      ...
      "modify bookings require a session or an API key. There is no self-service signup for keys:",
      "they are issued individually to partner organisations - email bakari@mail.dzaleka.com to ask.",
      "",
